...
Docker Compose installer for Matrix Synapse with Private Key SSL certificates (Root Key from main.sh).
...
This addon provides a fast, Docker Compose-based installation of Matrix Synapse using private key SSL certificates generated by main.sh. It uses your custom Root Key for secure, private deployments without requiring public domain names or Let's Encrypt.
